...
import { UserCheck, Calendar, ArrowLeft, TrendingUp, AlertTriangle } from 'lucide-react';
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <p className="text-gray-600 mt-2">
            Monitor your child's training and tournament attendance
          </p>
        </div>
          ...
          <div className="card p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-bold text-gray-900">{summary.absentSessions || 0}</p>
              </div>
            </div>
          </div>
        </div>
